...
describe("apiVersion extraction", () => {
  ...
  it("passes through an actual resolved version string", () => {
    ...
    const result = buildLanguageMetadata(optionMap, {}, "/repos/tsp-output", undefined, "2023-10-01");
  ...
  it("passes through 'multiple-versions' for multi-service configs", () => {
    ...
    const result = buildLanguageMetadata(optionMap, {}, "/repos/tsp-output", undefined, "multiple-versions");
